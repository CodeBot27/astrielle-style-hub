...
const contactInfo = [
  {
    icon: MapPin,
    title: "Visit Us",
    details: ["501 Main Street", "Cape Town, ZA 8001"],
  },
  {
    icon: Phone,
    title: "Call Us",
    details: ["+27 74 824 6945", "Mon-Fri: 9AM-6PM SAST"],
  },
  {
    icon: Mail,
    title: "Email Us",
    details: ["info@astrielle.com", "support@astrielle.com"],
  },
  {
    icon: Clock,
      ...
      <section className="py-20 md:py-28 gradient-bg">
        <div className="container-main">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1
              className="text-4xl md:text-5xl font-serif font-semibold mb-6 animate-fade-in"
